...
public class ItemDistribution : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (delay) {
            ...
            for (int i = 0; i < 25; i++) {
                location = new Vector3(Random.Range(-10.0f, -500.0f), 0, Random.Range(-240.0f, 240.0f));
            ...
            for (int i = 0; i < 10; i++) {
                location = new Vector3(100 + Random.Range(-32.0f, 32.0f), 0, Random.Range(-80.0f, 80.0f));
                rotation = Quaternion.identity;
